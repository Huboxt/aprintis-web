...
export class PaymentService implements OnDestroy {
  ...
  addDonation(publicationId: string, data: any): Observable<any> {
    return this.http
      .post<any>(
        this.apiService.getApiUrl(`Publications/${publicationId}/addDonation`),
        data
      )
    ...
    return this.http
      .post<any>(
        this.apiService.getApiUrl(
          `Publications/${publicationId}/addSubscription`
        ),
        data
      )
      .pipe(catchError(this.apiService.formatErrors));
  ...
  addPaymentForAd(publicationId: string, data: any): Observable<any> {
    return this.http
      .post<any>(
        this.apiService.getApiUrl(
          `Publications/${publicationId}/addPaymentForAd`
        ),
        data
      )
      .pipe(catchError(this.apiService.formatErrors));
  ...
  createCardToken(properties) {
    return this.stripeService.createToken(properties.card, {
  ...
  createBankAccountToken(properties) {
    return this.stripeService.createToken('bank_account', {
      country: 'US',
      currency: 'usd',
  ...
  createPayout(publicationId: string, data: any) {
    return this.http
      .post(
        this.apiService.getApiUrl(`Publications/${publicationId}/createPayout`),
        data
      )
      .pipe(catchError(this.apiService.formatErrors));
  }
