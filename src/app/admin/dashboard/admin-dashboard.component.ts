...
export class AdminDashboardComponent implements OnInit {
  ...
  searchFilter2 = new UntypedFormControl();
  statusFilter = new UntypedFormControl();
  statusFilter2 = new UntypedFormControl();
      ...
      async (ret) => {
        ...
        this.issues = ret.issues.map((o: Issue) => {
          const organizationName =
            o.organizationName || o.mailingAddress.organization;
          return {
            id: o.id,
            ...
            organization: organizationName
              ? organizationName.toString().trim()
              : '',
